// node_modules/.pnpm/effector@22.5.0/node_modules/effector/effector.mjs
function e(e2, t2) {
  for (let r2 in e2)
    t2(e2[r2], r2);
}
...
function c(e2, n2, a2, i2) {
  return Me(a2, n2, "first argument"), r(we(i2), "second argument should be a function"), se(!J(e2, "derived"), `${n2} in derived store`, `${n2} in store created via createStore`), t(Array.isArray(a2) ? a2 : [a2], (t2) => {
    e2.off(t2), H(e2).set(t2, gt(St(t2, e2, "on", Ce, i2)));
  }), e2;
}
function p(e2, n2) {
  ...
  let f2 = l2.id, m2 = { subscribers: /* @__PURE__ */ new Map(), updates: s2, defaultState: e2, stateRef: l2, getState() {
    ...
    let i2 = p(n3, { name: `${m2.shortName} → *`, derived: 1, and: r2 }), o3 = St(m2, i2, P, je, e3);
  ...
  m2.graphite = a({ scope: { state: l2, fn: h2 }, node: [De((e3, t2, r2) => (r2.scope && !r2.scope.reg[l2.id] && (r2.b = 1), e3)), Ee(l2), De((e3, t2, { a: r2, b: n3 }) => !Se(e3) && (e3 !== r2 || n3), 1), h2 && Re(je, 1), Ne({ from: _, target: l2 })], child: s2, meta: g2, regional: 1 });
  let y2 = J(m2, "serialize"), b2 = J(m2, "derived"), v2 = "ignore" === y2, k2 = !y2 || v2 ? 0 : y2, w2 = J(m2, "sid");
  return w2 && (v2 || K(m2, "storeChange", 1), l2.sid = w2, k2 && (l2.meta = { ...null == l2 ? void 0 : l2.meta, serialize: k2 })), w2 || v2 || b2 || K(m2, "warnSerialize", 1), r(b2 || !Se(e2), "current state can't be undefined, use null instead"), be(m2, [s2]), null != o2 && o2.domain && o2.domain.hooks.store(m2), b2 || (m2.reinit = d(), m2.reset(m2.reinit)), m2;
}
function m(...e2) {
  let t2, n2, a2;
  [e2, a2] = f(e2);
...
function y(e2, t2) {
  ...
  let s2 = o2.finally = d({ named: "finally", derived: 1 }), f2 = o2.done = s2.filterMap({ named: "done", fn({ status: e3, params: t3, result: r2 }) {
    ...
    let o3 = Mt(i2), l3 = $t(e3, t3, 1, s2, i2, o3), f3 = $t(e3, t3, 0, s2, i2, o3), [u3, d2] = zt(r2, f3, n3);
...
function b(e2) {
  ...
  let l2, { runner: u2 } = V(o2).scope, d2 = De((e3, t3, n3) => {
    let l3, { params: s2, req: f2, handler: u3 } = e3, d3 = o2.finally, c3 = Mt(n3), p2 = $t(s2, f2, 0, d3, n3, c3), m2 = n3.a, g2 = te(u3), h2 = 1;
    if (a2 ? [h2, l3] = zt(a2, p2, [s2, m2]) : l3 = r2 && g2 ? m2 : s2, h2) {
      if (!g2)
        return e3.args = [m2, l3], 1;
      i({ target: u3, params: { params: l3, req: { rs: $t(s2, f2, 1, d3, n3, c3), rj: p2 } }, page: n3.page, defer: 1, meta: n3.meta });
    }
  }, 1, 1);
  if (r2) {
    let e3;
...
function j(...t2) {
  ...
  r(X(l2), "source must be a unit"), n2 || (n2 = {}), p2 ? e(n2, (e2, t3) => $e(o2, e2, `cases.${t3}`)) : (r(h2, "match should be an object"), e(s2, (e2, t3) => n2[t3] = d({ derived: 1, and: c2 })), n2.__ = d({ derived: 1, and: c2 }));
...
function q(e2, n2) {
  ...
  let l2 = ((e3) => {
    let r2 = a({ scope: { defers: [], inFlight: 0, fxID: 0 }, node: [De((e4, t2, r3) => {
      ...
      if (n4) {
        ...
        if (!J(t3, "isCombine") || U(n4) && "combine" !== J(U(n4).node, "op")) {
          ...
          o4 && "ignore" !== o4 && (n5.sidSerializeMap[i4] = o4.write);
        }
      }
    ...
    })] }), o3 = { cloneOf: e3, reg: {}, sidValuesMap: {}, sidIdMap: {}, sidSerializeMap: {}, getState(e4) {
      if ("current" in e4)
...
function F(t2, n2 = {}) {
  ...
  return e(t2.sidValuesMap, (e2, r2) => {
    if (ie(a2, r2))
      return;
    let n3 = t2.sidIdMap[r2];
    i2[r2] = (t2.sidSerializeMap[r2] || Dt)(n3 && n3 in t2.reg ? t2.reg[n3].current : e2);
...
var $e = (e2, r2, n2 = "target") => t(ve(r2), (t2) => se(!J(t2, "derived"), `${e2}: derived unit in "${n2}"`, "createEvent/createStore"));
var je = (e2, { fn: t2 }, { a: r2 }) => t2(e2, r2);
var Ce = (e2, { fn: t2 }, { a: r2 }) => t2(r2, e2);
...
var yt = (e2) => {
  ...
  return Me(r2, t2, '"from"'), Me(n2, t2, '"to"'), $e(t2, n2, "to"), gt(a({ parent: r2, child: n2, meta: { op: t2, config: i2 }, family: {}, regional: 1 }));
};
...
var $t = (e2, t2, r2, n2, a2, o2) => (l2) => {
  o2.ref && oe(o2.ref.activeEffects, o2), i({ target: [n2, jt], params: [r2 ? { status: "done", params: e2, result: l2 } : { status: "fail", params: e2, error: l2 }, { value: l2, fn: r2 ? t2.rs : t2.rj }], defer: 1, page: a2.page, scope: o2.ref, meta: a2.meta });
};
var jt = a({ node: [Fe({ fn: ({ fn: e2, value: t2 }) => e2(t2) })], meta: { op: "fx", fx: "sidechain" } });
var Ct = ["source", "clock", "target"];
var At = (e2, t2) => e2 + `: ${t2} should be defined`;
var It = (e2, t2, n2, a2, i2, o2, l2, s2, f2, c2, g2, h2) => {
  let y2 = !!i2;
  r(!Se(n2) || !Se(t2), At(e2, "either source or clock"));
  let b2 = 0;
  Se(n2) ? b2 = 1 : X(n2) || (n2 = m(n2)), Se(t2) ? t2 = n2 : (Me(t2, e2, "clock"), Array.isArray(t2) && (t2 = S(t2))), b2 && (n2 = t2), s2 || l2 || (l2 = n2.shortName);
  let v2 = "none";
  (g2 || a2) && (X(a2) ? v2 = "unit" : (r(we(a2), "`filter` should be function or unit"), v2 = "fn")), i2 ? (Me(i2, e2, "target"), $e(e2, i2)) : "none" === v2 && c2 && Z(n2) && Z(t2) ? i2 = p(o2 ? o2(Ve(B(n2)), Ve(B(t2))) : Ve(B(n2)), { name: l2, sid: h2, or: s2 }) : (i2 = d({ name: l2, derived: 1, or: s2 }), u("sampleTarget", V(i2)));
  let k2 = _e(), w2 = [];
  if ("unit" === v2) {
    let [r2, n3] = Nt(a2, i2, t2, k2, e2);
    w2 = [...qt(n3), ...qt(r2)];
  }
  let [x2, z2] = Nt(n2, i2, t2, k2, e2), M2 = ht(t2, i2, [u("sampleSourceLoader"), Ne({ from: _, target: k2 }), ...qt(z2), Ee(x2, 1, f2), ...w2, Ee(k2), "fn" === v2 && Re((e3, t3, { a: r2 }) => a2(e3, r2), 1), o2 && Re(je), u("sampleSourceUpward", y2)], e2, o2);
  return be(n2, [M2]), Object.assign(M2.meta, s2, { joint: 1 }), i2;
};
...
//# sourceMappingURL=chunk-RGWNF6XI.js.map
