...
export const MapPlayGroundSidebar = () => {
	const [isActive, handleClick] = useUnit([model.$sidebarOpen, model.sidebarButtonClicked])

	return (
		<>
			<Container data-active={isActive}>
				<Content data-active={isActive}>
					<CreateClientLand.ClientLandPlotsList model={model.clientLandModel} />
				</Content>
			</Container>
